...
public class GdxSpriteBatch implements Batch {
    ...
    final Texture blankNormal = new Texture(Gdx.files.internal("blank_n.png"));
     ...
     * @see GdxSpriteBatch#GdxSpriteBatch(int, ShaderProgram) */
     ...
     * @see GdxSpriteBatch#GdxSpriteBatch(int, ShaderProgram) */
    public GdxSpriteBatch(int size) {
        this(size, null);
    }
    ...
    public GdxSpriteBatch(int size, ShaderProgram defaultShader) {
    ...
    private static ShaderProgram createNorShader(){
        ...
        if (norShader.isCompiled() == false) {
            Gdx.app.log("ShaderTest", norShader.getLog());
            Gdx.app.exit();
        }
        return norShader;
    }
    ...
    public void flush () {
        ...
        lastTexture.bind(0);
        if(lastTexture instanceof GdxNormapTexture && ((GdxNormapTexture) lastTexture).normap!=null){
            ((GdxNormapTexture)lastTexture).normap.bind(1);
        }else{
            blankNormal.bind(1);//准备一张空的
        }
        Mesh mesh = this.mesh;
