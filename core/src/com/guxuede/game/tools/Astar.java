...
/**
 * Created by guxuede on 2016/10/14 .
 */
...
public class Astar {
    ...
    public IntArray getPathClone (int startX, int startY, int targetX, int targetY) {
        IntArray path = getPath(startX,startY,targetX,targetY);
        IntArray newPath = new IntArray(path);
        return newPath;
    }
