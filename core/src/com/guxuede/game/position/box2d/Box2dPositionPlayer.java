 ...
 */
public class Box2dPositionPlayer implements PositionPlayer {
    private Body body;
    private Box2dPositionWorld positionWorld;
    private Vector2 linearVelocity;

    public Box2dPositionPlayer(Box2dPositionWorld positionWorld){
        this.positionWorld = positionWorld;

    }

    public void init(AnimationEntity animationEntity){
        float actorWidth= animationEntity.getWidth();
        /**********************************box2d************************************************/
    ...
    public void act(float delta,AnimationEntity entity) {
        ...
        entity.setCenterPosition(v.x,v.y);
    }
}
