...
//
//		orthographicCamera.physics.set(0, 0, 0);
...
//*/
//
//		//orthographicCamera.physics.x=actor.getX();
//		//orthographicCamera.physics.y=actor.getY();
//		//orthographicCamera.translate(viewActor.getX()-orthographicCamera.physics.x, viewActor.getY()-orthographicCamera.physics.y);
//		orthographicCamera.update();
//
//		//tileMapRenderer.setView(orthographicCamera);
//		//tileMapRenderer.render(LAYER1);
...
//
//		//parentToLocalCoordinates(tmp1.set(x-orthographicCamera.physics.x-Gdx.graphics.getWidth()/2, y-orthographicCamera.physics.y-Gdx.graphics.getHeight()/2));
//		//System.err.println(x+","+y+"-----"+tmp1);
//		//return super.hit(x+orthographicCamera.physics.x-Gdx.graphics.getWidth()/2, y+orthographicCamera.physics.y-Gdx.graphics.getHeight()/2, touchable);
///*		orthographicCamera.unproject(tmp.set(x, y, 0));
//		float yy=2*orthographicCamera.physics.y-tmp.y-1;
...
////
////        				System.out.println();
////        		        BodyDef bd = new BodyDef();bd.type=BodyType.StaticBody; bd.physics.set(w*32+16, (tt.getHeight()-h)*32-16);
////        				PolygonShape c=new PolygonShape();c.setAsBox(32/2, 32/2);
////        				Body physicsPlayer = world.createBody(bd); //通过world创建一个物体
////        				physicsPlayer.createFixture(c, 1f); //将形状和密度赋给物体
////        			}
////            	}
////        	}
////        }
